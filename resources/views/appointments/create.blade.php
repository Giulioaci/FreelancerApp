                ...
                <form action="{{ route('appointments.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500
                                   transition"
                            placeholder="Es. Incontro con cliente"
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            name="client_id"
                            required
                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 transition"
                        >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="3"
                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 transition"
                            placeholder="Dettagli dell'appuntamento...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('location') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 transition"
                            placeholder="Es. Napoli, Ufficio, Online"
                        >
                    </div>
